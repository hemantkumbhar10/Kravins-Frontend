...
const RecipeCard = () => {
  ...
  return (
    <Card
      sx={{ minWidth: 370, overflow: "auto !important", marginBottom: "1vh",px:1,boxShadow:'none', border:'1px solid #ede9e9' }}
...
<StyledMenu
        ...
        onClose={menuClose}
      >
        <MenuItem onClick={menuClose} disableRipple sx={{color:'#FF4B3A !important'}}>
          <EditIcon  sx={{color:'#FF4B3A !important'}}/>
          Edit
        </MenuItem>
        <MenuItem onClick={menuClose} disableRipple sx={{color:'red !important'}} >
